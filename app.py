...
def extract_skills(job_description):
    ...
    pattern = r"\b(?:python|java|sql|Machine learning|Hadoop|deep learning|data analysis|statistics|data visualization|Data Analyst|Natural Language Processing|computer vision|big data|cloud computing|database management|software development)\b"
...
def main():
    st.image("job-maching.jpg", use_column_width=True)
    ...
    st.text("Major Skills required for the job: {}".format(", ".join(job_skills)))
